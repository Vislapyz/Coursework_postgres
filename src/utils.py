...
from src.classes import Employer, Vacancy


def create_bd(database_name: str, params: dict) -> None:
    """Создает базу данных"""
...
def save_data_bd(employers_ids: list, database_name, params: dict):
...
def user_menu(database_name):
    """Интерактив с пользователем"""

    while True:
        print("Введите 1 - Вывести список работодателей в базе с количеством вакансий")
        print("Введите 2 - Вывести список всех вакансий в базе")
        print("Введите 3 - Вывести среднюю зарплату по всем вакансиям")
        print("Введите 4 - Вывести список вакансий с зарплатой выше средней по базе")
        print("Введите 5 - Вывести список вакансий с ключевым словом в названии")
        print("Введите 0 - Выход")
